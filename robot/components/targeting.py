...
class Targeting:
    ...
    def get_data(self):
        return TargetingData(x=scale(self.nt.getNumber('tx'), -27, 27, -1, 1),
                             y=scale(self.nt.getNumber('ty'),
                                     -20.5, 20.5, 1, 1),
                             area=scale(self.nt.getNumber('ta'), 0, 100, 0, 1),
                             skew=scale(self.nt.getNumber('ts'), -90, 0, 0, 1))
